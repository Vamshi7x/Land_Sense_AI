...
<h3 style="color:#fb8500;">👥 Contributors</h3>

<p style="font-size:14px; color:#555;">
<b>Swapna Reddy</b> — Data Science & ML Development<br>
<b>Your Team Member Name</b> — UI/UX Design<br>
<b>Another Contributor</b> — Data Engineering<br>
</p>

<p style="font-size:12px; color:#888;">
© 2026 LandSense AI · Built with ❤️ using Streamlit
</p>
