...
# ===============================
    ...
    utility_access = col14.selectbox("Utility Access", [0,1], format_func=lambda x: "No" if x else "Yes")
    govt_dev_plan = col15.selectbox("Government Development Plan", [0,1], format_func=lambda x: "No" if x else "Yes")

    col16, col17 = st.columns(2)
    flood_risk = col16.selectbox("Flood Risk", [0,1], format_func=lambda x: "No" if x else "Yes")
